...
Статус: технический preview на VPS развёрнут и проверен; HTTPS URL назначен тестовому боту в BotFather. Следующий шаг — Telegram UAT. Production, `main`, рабочий бот, рабочая база и существующие сайты не изменяются.
