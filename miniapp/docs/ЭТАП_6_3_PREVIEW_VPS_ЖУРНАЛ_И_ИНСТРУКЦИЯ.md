...
Статус: подготовка конфигурации. Production, `main`, рабочий бот, рабочая база и существующие сайты не изменяются.
...
- 2026-08-09: добавлены не содержащие секретов шаблоны systemd и Nginx для preview. Их установка на VPS и запуск службы ещё не выполнены.
