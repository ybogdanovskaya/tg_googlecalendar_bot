...
Статус: технический preview на VPS развёрнут и проверен. Назначение URL в BotFather и Telegram UAT ещё не выполнены. Production, `main`, рабочий бот, рабочая база и существующие сайты не изменяются.
